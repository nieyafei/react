...
import AuthMail from "../container/AuthMail";
import AuthIdentity from "../container/AuthIdentity";
...
import PerfectUserinfo from '../container/user/PerfectUserinfo';
...
import ImproveCase from '../container/user/ImproveCase';
import ImproveOpinion from '../container/user/ImproveOpinion';
import ImproveTech from '../container/user/ImproveTech';
import ComputerEdit from '../container/user/ComputerEdit';
...
import PushList from '../container/user/PushList';

/**
 * 主页
 * 企业 专家
 */
import CompanyHomepage from "../container/CompanyHomepage";
...
const RouteMap = (
    <Router history={browserHistory}>
        <Route path="/" component={NewRoots}>
            ...
            <Route path="register/authmail" component={AuthMail}/>
            <Route path="register/authidentity" component={AuthIdentity}/>
            ...
            <Route path="question/payment/:type/:id" component={Payment} />
            <Route path="question/result/:type" component={PaymentResult}/>
            {/* 关注 */}
            ...
            <Route path="user/perfect-userinfo" component={PerfectUserinfo}/>
            ...
            <Route path="user/push" component={PushList}/>
    
    
            <Route path="user/computer-edit/:type" component={ComputerEdit}/>
            <Route path="user/improve-case" component={ImproveCase}/>
            <Route path="user/improve-opinion" component={ImproveOpinion}/>
            <Route path="user/improve-tech" component={ImproveTech}/>
            


            {/* 详情 */}
            <Route path="case/info/:uri" component={CaseInfo}/>
            <Route path="question/detail/:uri" component={QuestionInfo}/>
            ...
            <Route path="/contact/expert/:id" component={ContactExpert}/>
            <Route path="/contact/pay/:id" component={ContactPay}/>
            <Route path="/contact/me/:uri" component={ContactMe}/>
            <Route path="/reply/info/:type/:id" component={ReplyInfo}/>
            <Route path="issue/info/:uri" component={IssueInfo}/>
