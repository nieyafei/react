...
class Main extends Component {
    ...
    render() {
            ...
            if (Util.IsNullJson(replyInfo)) {
                ...
                return (
                    <div className="reply_info_cons">
                        <div className="reply_list no_mtop no_bottom">
                            <div className="reply_cs">
                                <Link to={"/"+type+"/"+(type=="question"?"detail":"info")+"/"+replyInfo.qid} className="row_title">
                                ...
                                <div data-flex className="reply_head">
                                    <div className="le" data-flex="cross:center" data-flex-box="1">
                                        {replyInfo.expertIndexStream?
                                            <Link to={replyInfo.expertIndexStream.isExpert=="EXPERT"?"/expert/info/"+replyInfo.expertIndexStream.uid:""}>
        ...
        return (
            <div className="page page_hei_cons home_cons">
