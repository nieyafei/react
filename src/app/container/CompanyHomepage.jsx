...
class Main extends Component {
    ...
    constructor(props) {
        ...
        this.dataInit = () => {
            if (loadFlag) {
                ...
                setTimeout(() => {
                    ...
                    console.log("加载：" + type);
                    var url = "/api/user/"+type+ '/' + eUid + '/' + pageNum + '/' + PAGE_NUMBER;
         ...
         * 企业用户基本信息
         * */
        this.dataInitCompany = () => {
            var url = "/api/enterprise/info/"+eUid;
            Tool.fetchGet(url, "", {}, 'json', 'basic',
                (res) => {
    ...
    componentWillMount() {
        ...
        if (Util.isLogin(this.props)) {
            ...
            eUid = this.props.location.query.uid;//获取企业用户的id
    ...
    render() {
        ...
        var rowData = this.state.companyData;
        return (
            <div className="page company_page attention_page  attention_cons bg_color">
                <div className="header_height3">
                    <Header leftInfo="back" title="企业"/>
                    
                    <div className="company_info">
                        <AttentionEnterpriseList {...this.props} rowData={rowData} tabName={type} type="0" linkTo={"/enterprise/info/" + rowData.id} />
                    </div>
                ...
                <div className="scroll_list active">
                    <ListView
                        ...
                        style={{
                            ...
                            margin: '0', padding: "6.2rem 0 1.42rem 0"
                        }}
            ...
            <div className="home_menus active">
                <ul className="menu" data-flex="box:mean">
                    <li className={setCur.question}>
                        <Link to={"/company/homepage/?type=question&uid="+eUid}>问题</Link>
                    </li>
                    <li className={setCur.issue}>
                        <Link to={"/company/homepage/?type=issue&"+eUid}>需求</Link>
                    </li>
                </ul>
            </div>
        )
